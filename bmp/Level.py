...
MoveInfo = tuple[bmp.Object.Object, list[tuple[bmp.Ref.SpaceID, bmp.Locate.Coordinate, bmp.Locate.Direction]]]
...
class Level(object):
    def __init__(self, level_id: bmp.Ref.LevelID, space_list: list[bmp.Space.Space], *, super_level_id: Optional[bmp.Ref.LevelID] = None, main_space_id: Optional[bmp.Ref.SpaceID] = None, map_info: Optional[MapLevelExtraJson] = None, collected: Optional[dict[type[bmp.Collect.Collectible], bool]] = None, ) -> None:
        ...
        self.properties: dict[type[bmp.Object.LevelObject], bmp.Object.Properties] = {p: bmp.Object.Properties() for p in bmp.Object.level_object_types}
        self.special_operator_properties: dict[type[bmp.Object.LevelObject], dict[type[bmp.Object.Operator], bmp.Object.Properties]] = {p: {o: bmp.Object.Properties() for o in bmp.Object.special_operators} for p in bmp.Object.level_object_types}
        self.game_properties: bmp.Object.Properties = bmp.Object.Properties()
        self.created_levels: list["Level"] = []
        self.all_list: list[type[bmp.Object.Noun]] = []
        self.group_references: dict[type[bmp.Object.GroupNoun], bmp.Object.Properties] = {p: bmp.Object.Properties() for p in bmp.Object.group_noun_types}
    ...
    def find_super_spaces(self, space_object_id: bmp.Ref.SpaceID) -> list[tuple[bmp.Space.Space, bmp.Object.SpaceObject]]:
        return_value: list[tuple[bmp.Space.Space, bmp.Object.SpaceObject]] = []
    ...
    def refresh_all_list(self) -> None:
        for space in self.space_list:
            for obj in space.object_list:
                if all(map(lambda t: isinstance(obj, t), bmp.Object.types_not_in_all)):
                    noun_type = bmp.Object.get_noun_from_type(type(obj))
    ...
    def merge_move_list(move_list: list[MoveInfo]) -> list[MoveInfo]:
        move_dict: dict[bmp.Object.Object, list[tuple[bmp.Ref.SpaceID, bmp.Locate.Coordinate, bmp.Locate.Direction]]] = {}
    ...
    def meet_prefix_conditions(self, space: bmp.Space.Space, obj: bmp.Object.Object, prefix_info_list: list[bmp.Rule.PrefixInfo], is_meta: bool = False) -> bool:
        return_value = True
        for prefix_info in prefix_info_list:
            meet_prefix_condition = True
            if prefix_info.prefix_type == bmp.Object.TextMeta:
                meet_prefix_condition = is_meta
            elif prefix_info.prefix_type == bmp.Object.TextOften:
                meet_prefix_condition = random.choice((True, True, True, False))
            elif prefix_info.prefix_type == bmp.Object.TextSeldom:
        ...
        return return_value
    def meet_infix_conditions(self, space: bmp.Space.Space, obj: bmp.Object.Object, infix_info_list: list[bmp.Rule.InfixInfo], old_feeling: Optional[bmp.Object.Properties] = None) -> bool:
        for infix_info in infix_info_list:
            meet_infix_condition = True
            if infix_info.infix_type in (bmp.Object.TextOn, bmp.Object.TextNear, bmp.Object.TextNextto):
                matched_objs: list[bmp.Object.Object] = [obj]
                find_range: list[bmp.Locate.Coordinate]
                if infix_info.infix_type == bmp.Object.TextOn:
                    find_range = [bmp.Locate.Coordinate(obj.pos.x, obj.pos.y)]
                elif infix_info.infix_type == bmp.Object.TextNear:
                    find_range = [bmp.Locate.Coordinate(obj.pos.x - 1, obj.pos.y - 1), bmp.Locate.Coordinate(obj.pos.x, obj.pos.y - 1), bmp.Locate.Coordinate(obj.pos.x + 1, obj.pos.y - 1),
                                  bmp.Locate.Coordinate(obj.pos.x - 1, obj.pos.y), bmp.Locate.Coordinate(obj.pos.x, obj.pos.y), bmp.Locate.Coordinate(obj.pos.x + 1, obj.pos.y),
                                  bmp.Locate.Coordinate(obj.pos.x - 1, obj.pos.y + 1), bmp.Locate.Coordinate(obj.pos.x, obj.pos.y + 1), bmp.Locate.Coordinate(obj.pos.x + 1, obj.pos.y + 1)]
                elif infix_info.infix_type == bmp.Object.TextNextto:
                    find_range = [bmp.Locate.Coordinate(obj.pos.x, obj.pos.y - 1), bmp.Locate.Coordinate(obj.pos.x - 1, obj.pos.y), bmp.Locate.Coordinate(obj.pos.x + 1, obj.pos.y), bmp.Locate.Coordinate(obj.pos.x, obj.pos.y + 1)]
                for match_negated, match_noun in infix_info[2]: # type: ignore
                    match_objs: list[bmp.Object.Object] = []
                    match_noun: type[bmp.Object.Noun]
                    match_noun_list: list[type[bmp.Object.Noun]] = []
                    if match_noun == bmp.Object.TextAll:
                        if match_negated:
                            match_noun_list = [o for o in self.all_list if issubclass(o, bmp.Object.nouns_in_not_all)]
                        else:
                            match_noun_list = [o for o in self.all_list if not issubclass(o, bmp.Object.nouns_not_in_all)]
                    else:
                        if match_negated:
                            match_noun_list = [o for o in self.all_list if (not issubclass(o, bmp.Object.nouns_not_in_all)) and not issubclass(o, match_noun)]
                        else:
                            match_noun_list = [match_noun]
                    for new_match_noun in match_noun_list:
                        if issubclass(new_match_noun, bmp.Object.SupportsIsReferenceOf):
                    ...
                    if not meet_infix_condition:
                        break
            elif infix_info.infix_type == bmp.Object.TextFeeling:
                if old_feeling is None:
                    ...
                    for infix_noun_info in infix_info.infix_noun_info_list:
                        if old_feeling.enabled(infix_noun_info.infix_noun_type) == infix_noun_info.negated:
                            meet_infix_condition = False
            elif infix_info.infix_type == bmp.Object.TextWithout:
                meet_infix_condition = True
                matched_objs: list[bmp.Object.Object] = [obj]
                match_type_count: dict[tuple[bool, type[bmp.Object.Noun]], int] = {}
                for match_negated, match_noun in infix_info[2]: # type: ignore
                    match_noun: type[bmp.Object.Noun]
    ...
    def destroy_obj(self, space: bmp.Space.Space, obj: bmp.Object.Object) -> None:
        space.del_obj(obj)
        for new_noun_type, new_noun_count in obj.special_operator_properties[bmp.Object.TextHas].enabled_dict().items(): # type: ignore
            new_noun_type: type[bmp.Object.Noun]
            if issubclass(new_noun_type, bmp.Object.RangedNoun):
                continue
            new_object_type: type[bmp.Object.Object] = new_noun_type.ref_type
            if issubclass(new_noun_type, bmp.Object.TextText):
                new_object_type = bmp.Object.get_noun_from_type(type(obj))
            for _ in range(new_noun_count):
                if issubclass(new_object_type, bmp.Object.Game):
                    if isinstance(obj, (bmp.Object.LevelObject, bmp.Object.SpaceObject)):
                        space.new_obj(bmp.Object.Game(obj.pos, obj.direct, ref_type=bmp.Object.get_noun_from_type(type(obj))))
                    else:
                        space.new_obj(bmp.Object.Game(obj.pos, obj.direct, ref_type=type(obj)))
                elif issubclass(new_object_type, bmp.Object.LevelObject):
                    level_object_extra: bmp.Object.LevelObjectExtra = {"icon": {"name": obj.json_name, "color": bmp.Color.current_palette[obj.sprite_color]}}
                ...
                elif issubclass(new_object_type, bmp.Object.SpaceObject):
    ...
    def get_move_list(self, space: bmp.Space.Space, obj: bmp.Object.Object, \
        direct: bmp.Locate.Direction, pos: Optional[bmp.Locate.Coordinate] = None, \
            pushed: Optional[list[bmp.Object.Object]] = None, passed: Optional[list[bmp.Ref.SpaceID]] = None, \
        ...
        new_pos = bmp.Locate.front_position(pos, direct)
        leave_space = False
        leave_list: list[MoveInfo] = []
        if space.out_of_range(new_pos) and not obj.properties.disabled(bmp.Object.TextLeave):
            ...
            if old_space is not None:
                ...
                for super_space, space_obj in super_space_list:
                    if old_space.properties[type(space_obj)].disabled(bmp.Object.TextLeave):
                        continue
                    ...
                    new_direct = bmp.Locate.swap_direction(direct) if transform["flip"] and direct in (bmp.Locate.Direction.A, bmp.Locate.Direction.D) else direct
                    new_direct = bmp.Locate.turn(new_direct, bmp.Locate.str_to_direct(transform["direct"]))
        ...
        push_objects = [o for o in space.get_objs_from_pos(new_pos) if o.properties.enabled(bmp.Object.TextPush)]
        unpushable_objects: list[bmp.Object.Object] = []
        push = False
        ...
        if not space.out_of_range(new_pos):
            stop_objects = [o for o in space.get_objs_from_pos(new_pos) if o.properties.enabled(bmp.Object.TextStop) and not o.properties.enabled(bmp.Object.TextPush)]
            if len(stop_objects + unpushable_objects) != 0:
                push = False
                if obj.properties.enabled(bmp.Object.TextOpen):
                    simple = True
                    for stop_object in stop_objects + unpushable_objects:
                        if not stop_object.properties.enabled(bmp.Object.TextShut):
                            simple = False
                elif obj.properties.enabled(bmp.Object.TextShut):
                    simple = True
                    for stop_object in stop_objects + unpushable_objects:
                        if not stop_object.properties.enabled(bmp.Object.TextOpen):
                            simple = False
            else:
                simple = True
        squeeze = False
        squeeze_list: list[MoveInfo] = []
        if isinstance(obj, bmp.Object.SpaceObject) and (not space.out_of_range(new_pos)) and (not simple) and len(stop_objects) == 0:
            squeeze_space = self.get_space(obj.space_id)
            if squeeze_space is not None:
                if not squeeze_space.properties[type(obj)].disabled(bmp.Object.TextEnter):
                    squeeze = True
                    for new_push_object in push_objects:
                        if new_push_object.properties.disabled(bmp.Object.TextEnter):
                            squeeze = False
                            break
                        transform = bmp.Locate.inverse_transform(squeeze_space.get_stacked_transform(obj.space_object_extra["static_transform"], obj.space_object_extra["dynamic_transform"]))
                        new_direct = bmp.Locate.swap_direction(direct) if transform["flip"] and direct in (bmp.Locate.Direction.A, bmp.Locate.Direction.D) else direct
                        new_direct = bmp.Locate.turn(new_direct, bmp.Locate.str_to_direct(transform["direct"]))
                        input_pos = squeeze_space.get_enter_pos_by_default(new_direct, transform)
                        squeeze_move_list = self.get_move_list(squeeze_space, new_push_object, bmp.Locate.swap_direction(new_direct), input_pos, pushed=pushed + [obj], depth=depth)
        ...
        if not space.out_of_range(new_pos) and not obj.properties.disabled(bmp.Object.TextEnter):
            sub_space_obj_list = [o for o in space.get_spaces_from_pos(new_pos) if not o.properties.disabled(bmp.Object.TextEnter)]
            for sub_space_obj in sub_space_obj_list:
                sub_space = self.get_space(sub_space_obj.space_id)
                if sub_space is None:
                    enter_space = True
                    continue
                if sub_space.properties[type(sub_space_obj)].disabled(bmp.Object.TextEnter):
                    continue
                if passed.count(sub_space.space_id) > infinite_move_number:
                    ...
                    if epsilon_space is None:
                        enter_space = True
                        continue
                    if epsilon_space.properties[type(sub_space_obj)].disabled(bmp.Object.TextEnter):
                        continue
                    epsilon_space_list = self.find_super_spaces(epsilon_space.space_id)
                    for _, epsilon_space_obj in epsilon_space_list:
                        if epsilon_space_obj.properties.disabled(bmp.Object.TextEnter):
                            continue
                        transform = bmp.Locate.inverse_transform(epsilon_space.get_stacked_transform(epsilon_space_obj.space_object_extra["static_transform"], epsilon_space_obj.space_object_extra["dynamic_transform"]))
                        new_direct = bmp.Locate.swap_direction(direct) if transform["flip"] and direct in (bmp.Locate.Direction.A, bmp.Locate.Direction.D) else direct
                        new_direct = bmp.Locate.turn(new_direct, bmp.Locate.str_to_direct(transform["direct"]))
                        input_pos = epsilon_space.get_enter_pos_by_default(bmp.Locate.swap_direction(new_direct), transform)
                        new_transnum = 0.5
                        passed.append(space.space_id)
                        new_move_list = self.get_move_list(epsilon_space, obj, bmp.Locate.swap_direction(new_direct), input_pos, pushed, passed, new_transnum, depth)
                        if new_move_list is not None:
                ...
                inversed_transform = bmp.Locate.inverse_transform(transform)
                new_direct = bmp.Locate.swap_direction(direct) if inversed_transform["flip"] and direct in (bmp.Locate.Direction.A, bmp.Locate.Direction.D) else direct
                new_direct = bmp.Locate.turn(new_direct, bmp.Locate.str_to_direct(inversed_transform["direct"]))
                if transnum is not None:
                    input_pos = sub_space.get_enter_pos(transnum, bmp.Locate.swap_direction(direct), inversed_transform)
                    new_transnum = space.calc_enter_transnum(transnum, sub_space_obj.pos, bmp.Locate.swap_direction(direct), inversed_transform)
                else:
                    input_pos = sub_space.get_enter_pos_by_default(bmp.Locate.swap_direction(direct), inversed_transform)
                    new_transnum = 0.5
                passed.append(space.space_id)
        ...
        if leave_space:
            ...
            return None
    def you(self, direct: bmp.Locate.NullableDirection) -> bool:
        self.reset_move_numbers()
        if direct == bmp.Locate.NullDirection.O:
            return False
        pushing_game = False
        finished = False
        for _ in range(max_move_count):
            ...
            finished = True
            for space in self.space_list:
                you_objs = [o for o in space.object_list if o.move_number < o.properties.get(bmp.Object.TextYou)]
                if len(you_objs) != 0:
                    finished = False
                for obj in you_objs:
                    obj.direct = direct
        ...
        return pushing_game
    def select(self, direct: bmp.Locate.NullableDirection) -> Optional[bmp.Ref.LevelID]:
        if direct == bmp.Locate.NullDirection.O:
            level_objs: list[bmp.Object.LevelObject] = []
            for space in self.space_list:
                select_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextSelect)]
            ...
            for space in self.space_list:
                select_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextSelect)]
                for obj in select_objs:
                    new_pos = bmp.Locate.front_position(obj.pos, direct)
                    if not space.out_of_range(new_pos):
                        level_objs = space.get_levels_from_pos(new_pos)
                        path_objs = space.get_objs_from_pos_and_type(new_pos, bmp.Object.Path)
                        if any(map(lambda p: p.unlocked, path_objs)) or len(level_objs) != 0:
                            obj.pos = new_pos
            return None
    def direction(self) -> None:
        for prop in bmp.Object.direct_fix_properties:
            for space in self.space_list:
                for obj in space.object_list:
                    if obj.properties.enabled(prop):
                        if isinstance(obj, bmp.Object.SpaceObject):
                            obj.space_object_extra["static_transform"] = prop.ref_transform.copy()
                        obj.direct = prop.ref_direct
                if space.properties[bmp.Object.default_space_object_type].enabled(prop):
                    space.static_transform = prop.ref_transform.copy()
            if self.properties[bmp.Object.default_level_object_type].enabled(prop):
                pass # NotImplemented
    def flip(self) -> None:
        for space in self.space_list:
            space.dynamic_transform = bmp.Locate.default_space_transform.copy()
            for obj in space.get_spaces():
                obj.space_object_extra["dynamic_transform"] = bmp.Locate.default_space_transform.copy()
        for prop in bmp.Object.direct_mapping_properties:
            for space in self.space_list:
                for obj in space.object_list:
                    if obj.properties.get(prop) % 2 == 1:
                        if isinstance(obj, bmp.Object.SpaceObject):
                            obj.space_object_extra["dynamic_transform"] = bmp.Locate.get_stacked_transform(obj.space_object_extra["dynamic_transform"], prop.ref_transform)
                        obj.set_direct_mapping(prop.ref_mapping)
                if space.properties[bmp.Object.default_space_object_type].get(prop) % 2 == 1:
                    space.dynamic_transform = bmp.Locate.get_stacked_transform(space.dynamic_transform, prop.ref_transform)
            if self.properties[bmp.Object.default_level_object_type].get(prop) % 2 == 1:
                pass # NotImplemented
    def turn(self) -> None:
        for space in self.space_list:
            for obj in space.object_list:
                turn_count = (obj.properties.get(bmp.Object.TextTurn) - obj.properties.get(bmp.Object.TextDeturn)) % 4
                for _ in range(turn_count):
                    obj.direct = bmp.Locate.turn_right(obj.direct)
                    if isinstance(obj, bmp.Object.SpaceObject):
                        obj.space_object_extra["static_transform"] = bmp.Locate.get_stacked_transform(obj.space_object_extra["static_transform"], {"direct": "A", "flip": False})
            turn_count = (space.properties[bmp.Object.default_space_object_type].get(bmp.Object.TextTurn) - space.properties[bmp.Object.default_space_object_type].get(bmp.Object.TextDeturn)) % 4
            for _ in range(turn_count):
                space.static_transform = bmp.Locate.get_stacked_transform(space.static_transform, {"direct": "A", "flip": False})
        if self.properties[bmp.Object.default_level_object_type].get(bmp.Object.TextFlip) % 2 == 1:
            pass # NotImplemented
    def move(self) -> bool:
        self.reset_move_numbers()
        pushing_game = False
        for space in self.space_list:
            global_move_count = space.properties[bmp.Object.default_space_object_type].get(bmp.Object.TextMove) + self.properties[bmp.Object.default_level_object_type].get(bmp.Object.TextMove)
            for _ in range(global_move_count):
                move_list = []
                for obj in [o for o in space.object_list if o.move_number < global_move_count]:
                    if not obj.properties.enabled(bmp.Object.TextFloat):
                        new_move_list = self.get_move_list(space, obj, bmp.Locate.Direction.S)
                        if new_move_list is not None:
                            move_list.extend(new_move_list)
                            obj.move_number += 1
                        else:
        ...
        for _ in range(max_move_count):
            ...
            finished = True
            for space in self.space_list:
                move_objs = [o for o in space.object_list if o.move_number < o.properties.get(bmp.Object.TextMove)]
                if len(move_objs) != 0:
                    finished = False
                for obj in move_objs:
                    ...
                    if new_move_list is not None:
                        ...
                        obj.direct = bmp.Locate.swap_direction(obj.direct)
                        new_move_list = self.get_move_list(space, obj, obj.direct)
                        if new_move_list is not None:
                            move_list = new_move_list
                            obj.move_number += 1
    ...
    def shift(self) -> bool:
        ...
        pushing_game = False
        for space in self.space_list:
            global_shift_count = space.properties[bmp.Object.default_space_object_type].get(bmp.Object.TextShift) + self.properties[bmp.Object.default_level_object_type].get(bmp.Object.TextShift)
        ...
        for _ in range(max_move_count):
            ...
            finished = True
            for space in self.space_list:
                shifter_objs = [o for o in space.object_list if o.move_number < o.properties.get(bmp.Object.TextShift)]
                for shifter_obj in shifter_objs:
                    shifted_objs = [o for o in space.get_objs_from_pos(shifter_obj.pos) if obj != shifter_obj and bmp.Object.same_float_prop(obj, shifter_obj)]
        ...
        return pushing_game
    def tele(self) -> None:
        if self.properties[bmp.Object.default_level_object_type].enabled(bmp.Object.TextTele):
            pass
        for space in self.space_list:
            if space.properties[bmp.Object.default_space_object_type].enabled(bmp.Object.TextTele):
                pass
        tele_list: list[tuple[bmp.Space.Space, bmp.Object.Object, bmp.Space.Space, bmp.Locate.Coordinate]] = []
        object_list: list[tuple[bmp.Space.Space, bmp.Object.Object]] = []
        for space in self.space_list:
            object_list.extend([(space, o) for o in space.object_list])
        tele_objs = [t for t in object_list if t[1].properties.enabled(bmp.Object.TextTele)]
        tele_object_types: dict[type[bmp.Object.Object], list[tuple[bmp.Space.Space, bmp.Object.Object]]] = {}
        for object_type in [n.ref_type for n in bmp.Object.noun_class_list]:
        ...
        for new_tele_objs in tele_object_types.values():
            ...
            for tele_space, tele_obj in new_tele_objs:
                ...
                for obj in space.get_objs_from_pos(tele_obj.pos):
                    if obj == tele_obj:
                        continue
                    if bmp.Object.same_float_prop(obj, tele_obj):
    ...
    def sink(self) -> None:
        ...
        for space in self.space_list:
            delete_list = []
            if space.properties[bmp.Object.default_space_object_type].enabled(bmp.Object.TextSink) or self.properties[bmp.Object.default_level_object_type].enabled(bmp.Object.TextSink):
                for obj in space.object_list:
                    if not obj.properties.enabled(bmp.Object.TextFloat):
                        delete_list.append(obj)
            sink_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextSink)]
            for sink_obj in sink_objs:
                for obj in space.get_objs_from_pos(sink_obj.pos):
                    if obj == sink_obj:
                        continue
                    if obj.pos == sink_obj.pos:
                        if bmp.Object.same_float_prop(obj, sink_obj):
    ...
    def hot_and_melt(self) -> None:
        ...
        for space in self.space_list:
            delete_list = []
            melt_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextMelt)]
            hot_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextHot)]
            if len(hot_objs) != 0 and (space.properties[bmp.Object.default_space_object_type].enabled(bmp.Object.TextMelt) or self.properties[bmp.Object.default_level_object_type].enabled(bmp.Object.TextMelt)):
                for melt_obj in melt_objs:
                    if not melt_obj.properties.enabled(bmp.Object.TextFloat):
                        delete_list.extend(space.object_list)
                continue
            if len(melt_objs) != 0 and (space.properties[bmp.Object.default_space_object_type].enabled(bmp.Object.TextHot) or self.properties[bmp.Object.default_level_object_type].enabled(bmp.Object.TextHot)):
                for melt_obj in melt_objs:
                    if not melt_obj.properties.enabled(bmp.Object.TextFloat):
            ...
            for hot_obj in hot_objs:
                for melt_obj in melt_objs:
                    if hot_obj.pos == melt_obj.pos:
                        if bmp.Object.same_float_prop(hot_obj, melt_obj):
    ...
    def defeat(self) -> None:
        ...
        for space in self.space_list:
            delete_list = []
            you_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextYou)]
            defeat_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextDefeat)]
            if len(defeat_objs) != 0 and (space.properties[bmp.Object.default_space_object_type].enabled(bmp.Object.TextYou) or self.properties[bmp.Object.default_level_object_type].enabled(bmp.Object.TextYou)):
                delete_list.extend(space.object_list)
                continue
            for you_obj in you_objs:
                if space.properties[bmp.Object.default_space_object_type].enabled(bmp.Object.TextDefeat) or self.properties[bmp.Object.default_level_object_type].enabled(bmp.Object.TextDefeat):
                    if you_obj not in delete_list:
                        delete_list.append(you_obj)
                        continue
                for defeat_obj in defeat_objs:
                    if you_obj.pos == defeat_obj.pos:
                        if bmp.Object.same_float_prop(defeat_obj, you_obj):
                            if you_obj not in delete_list:
                                delete_list.append(you_obj)
            for obj in delete_list:
                self.destroy_obj(space, obj)
    ...
    def bonus(self) -> None:
        ...
        for space in self.space_list:
            delete_list = []
            bonus_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextBonus)]
            you_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextYou)]
            if len(you_objs) != 0 and (space.properties[bmp.Object.default_space_object_type].enabled(bmp.Object.TextBonus) or self.properties[bmp.Object.default_level_object_type].enabled(bmp.Object.TextBonus)):
                delete_list.extend(space.object_list)
                continue
            for bonus_obj in bonus_objs:
                if space.properties[bmp.Object.default_space_object_type].enabled(bmp.Object.TextYou) or self.properties[bmp.Object.default_level_object_type].enabled(bmp.Object.TextYou):
                    if bonus_obj not in delete_list:
                        delete_list.append(bonus_obj)
                        continue
                for you_obj in you_objs:
                    if bonus_obj.pos == you_obj.pos:
                        if bmp.Object.same_float_prop(you_obj, bonus_obj):
                            if bonus_obj not in delete_list:
                                delete_list.append(bonus_obj)
            for obj in delete_list:
                self.destroy_obj(space, obj)
    ...
    def open_and_shut(self) -> None:
        ...
        for space in self.space_list:
            delete_list = []
            shut_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextShut)]
            open_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextOpen)]
            if len(open_objs) != 0 and (space.properties[bmp.Object.default_space_object_type].enabled(bmp.Object.TextShut) or self.properties[bmp.Object.default_level_object_type].enabled(bmp.Object.TextShut)):
                delete_list.extend(space.object_list)
                continue
            if len(shut_objs) != 0 and (space.properties[bmp.Object.default_space_object_type].enabled(bmp.Object.TextOpen) or self.properties[bmp.Object.default_level_object_type].enabled(bmp.Object.TextOpen)):
                delete_list.extend(space.object_list)
                continue
    ...
    def make(self) -> None:
        for space in self.space_list:
            for obj in space.object_list:
                for make_noun_type, make_noun_count in obj.special_operator_properties[bmp.Object.TextMake].enabled_dict().items(): # type: ignore
                    make_noun_type: type[bmp.Object.Noun]
                    if issubclass(make_noun_type, bmp.Object.RangedNoun):
                        continue
                    make_object_type: type[bmp.Object.Object] = make_noun_type.ref_type
                    if issubclass(make_noun_type, bmp.Object.TextText):
                        make_object_type = bmp.Object.get_noun_from_type(type(obj))
                    if len(space.get_objs_from_pos_and_type(obj.pos, make_object_type)) != 0:
                        continue
                    for _ in range(make_noun_count):
                        if issubclass(make_object_type, bmp.Object.Game):
                            if isinstance(obj, (bmp.Object.LevelObject, bmp.Object.SpaceObject)):
                                space.new_obj(bmp.Object.Game(obj.pos, obj.direct, ref_type=bmp.Object.get_noun_from_type(type(obj))))
                            else:
                                space.new_obj(bmp.Object.Game(obj.pos, obj.direct, ref_type=type(obj)))
                        elif issubclass(make_object_type, bmp.Object.LevelObject):
                            if len(space.get_objs_from_pos_and_type(obj.pos, make_object_type)) == 0:
                                level_object_extra: bmp.Object.LevelObjectExtra = {"icon": {"name": obj.json_name, "color": bmp.Color.current_palette[obj.sprite_color]}}
                                if obj.level_id is not None:
                        ...
                        elif issubclass(make_object_type, bmp.Object.SpaceObject):
                            if len(space.get_objs_from_pos_and_type(obj.pos, make_object_type)) == 0:
                                if obj.space_id is not None:
    ...
    def text_plus_and_text_minus(self) -> None:
        for space in self.space_list:
            delete_list = []
            text_plus_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextTextPlus)]
            text_minus_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextTextMinus)]
            for text_plus_obj in text_plus_objs:
                if text_plus_obj in text_minus_objs:
                    continue
                new_type = bmp.Object.get_noun_from_type(type(text_plus_obj))
                if not issubclass(new_type, bmp.Object.TextText):
            ...
            for text_minus_obj in text_minus_objs:
                if text_minus_obj in text_plus_objs:
                    continue
                if not isinstance(text_minus_obj, bmp.Object.Noun):
                    continue
                new_type = text_minus_obj.ref_type
                if new_type == bmp.Object.Text:
                    continue
                delete_list.append(text_minus_obj)
                if issubclass(new_type, bmp.Object.Game):
                    space.new_obj(bmp.Object.Game(text_minus_obj.pos, text_minus_obj.direct, ref_type=bmp.Object.TextGame))
                elif issubclass(new_type, bmp.Object.LevelObject):
                    level_object_extra: bmp.Object.LevelObjectExtra = {"icon": {"name": text_minus_obj.json_name, "color": bmp.Color.current_palette[text_minus_obj.sprite_color]}}
                    if text_minus_obj.level_id is not None:
                        ...
                        space.new_obj(new_type(text_minus_obj.pos, text_minus_obj.direct, level_id=self.level_id, level_object_extra=level_object_extra))
                elif issubclass(new_type, bmp.Object.SpaceObject):
    ...
    def game(self) -> None:
        for space in self.space_list:
            for game_obj in space.get_objs_from_type(bmp.Object.Game):
    ...
    def win(self) -> bool:
        for space in self.space_list:
            you_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextYou)]
            win_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextWin)]
            for you_obj in you_objs:
                if you_obj in win_objs:
                    self.collected[bmp.Collect.Spore] = True
                    return True
                if space.properties[bmp.Object.default_space_object_type].enabled(bmp.Object.TextWin) or self.properties[bmp.Object.default_level_object_type].enabled(bmp.Object.TextWin):
                    if not you_obj.properties.enabled(bmp.Object.TextFloat):
                        self.collected[bmp.Collect.Spore] = True
                        return True
                for win_obj in win_objs:
                    if you_obj.pos == win_obj.pos:
                        if bmp.Object.same_float_prop(you_obj, win_obj):
                            self.collected[bmp.Collect.Spore] = True
                            return True
        return False
    def end(self) -> bool:
        for space in self.space_list:
            you_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextYou)]
            end_objs = [o for o in space.object_list if o.properties.enabled(bmp.Object.TextEnd)]
            for you_obj in you_objs:
                if you_obj in end_objs:
                    return True
                if space.properties[bmp.Object.default_space_object_type].enabled(bmp.Object.TextEnd) or self.properties[bmp.Object.default_level_object_type].enabled(bmp.Object.TextEnd):
                    if not you_obj.properties.enabled(bmp.Object.TextFloat):
                        return True
                for end_obj in end_objs:
                    if you_obj.pos == end_obj.pos:
                        if bmp.Object.same_float_prop(you_obj, end_obj):
                            return True
        return False
    def done(self) -> bool:
        for space in self.space_list:
            delete_list = []
            if space.properties[bmp.Object.default_space_object_type].enabled(bmp.Object.TextDone) or self.properties[bmp.Object.default_level_object_type].enabled(bmp.Object.TextDone):
                delete_list.extend(space.object_list)
            for obj in space.object_list:
                if obj.properties.enabled(bmp.Object.TextDone):
                    delete_list.append(obj)
            for obj in delete_list:
                space.del_obj(obj)
        ...
        for space in self.space_list:
            if [bmp.Object.TextAll, bmp.Object.TextIs, bmp.Object.TextDone] in space.rule_list:
                return True
        return False
    def have_you(self) -> bool:
        for space in self.space_list:
            for obj in space.object_list:
                if obj.properties.enabled(bmp.Object.TextYou):
                    return True
        return False
    def recursion_get_object_surface_info(
        self,
        old_pos: bmp.Locate.Coordinate,
        ...
        if current_space_id in passed:
            ...
            for space_obj in current_space.get_spaces():
                ...
                for new_depth, new_pos, new_size in self.recursion_get_object_surface_info(old_pos, old_space_id, current_space_id - 1, passed=new_passed):
                    return_list.append((
                        new_depth + 1,
                        bmp.Locate.transform_relative_pos(
                            bmp.Locate.default_space_transform, # NotImplemented
        ...
        return return_list
    def space_to_surface(self, space: bmp.Space.Space, wiggle: int, size: bmp.Locate.CoordTuple, depth: int = 0, smooth: Optional[float] = None, cursor: Optional[bmp.Locate.Coordinate] = None, debug: bool = False) -> pygame.Surface:
        ...
        if depth > bmp.Base.options["space_display_recursion_depth"] or space.properties[bmp.Object.default_space_object_type].enabled(bmp.Object.TextHide):
            space_surface = pygame.Surface((scaled_sprite_size, scaled_sprite_size), pygame.SRCALPHA)
            space_surface.fill(space.color)
            space_surface = bmp.Render.simple_object_to_surface(bmp.Object.SpaceObject(bmp.Locate.Coordinate(0, 0), space_id=space.space_id), default_surface=space_surface)
        ...
        object_list: list[bmp.Object.Object] = []
        obj_surface_list: list[tuple[bmp.Locate.Coordinate, bmp.Locate.Coordinate, pygame.Surface, bmp.Object.Object]] = []
        ...
        for obj in object_list:
            if not isinstance(obj, bmp.Render.order):
                continue
            if obj.properties.enabled(bmp.Object.TextHide):
                continue
            obj_surface: pygame.Surface = bmp.Render.simple_object_to_surface(obj, wiggle=wiggle, debug=debug)
            if self.game_properties.enabled(bmp.Object.TextWord):
                obj_type = type(obj)
                for _ in range(self.game_properties.get(bmp.Object.TextWord)):
                    obj_type = bmp.Object.get_noun_from_type(obj_type)
                obj_surface = bmp.Render.simple_type_to_surface(obj_type, wiggle=wiggle, debug=debug)
            obj_surface_pos: bmp.Locate.Coordinate = bmp.Locate.Coordinate(obj.pos.x * scaled_sprite_size, obj.pos.y * scaled_sprite_size)
            obj_surface_size: bmp.Locate.Coordinate = bmp.Locate.Coordinate(scaled_sprite_size, scaled_sprite_size)
            if isinstance(obj, bmp.Object.SpaceObject):
                ...
                transform = bmp.Locate.get_stacked_transform(obj.space_object_extra["static_transform"], obj.space_object_extra["dynamic_transform"])
                if transform["flip"]:
        ...
        transform = bmp.Locate.get_stacked_transform(space.static_transform, space.dynamic_transform)
        if transform["flip"]:

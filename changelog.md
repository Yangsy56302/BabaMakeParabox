...
#### 3.923
Baba Make Parabox v3.923 是 2024.12.09 更新的一个版本，修复了一些漏洞。
...
#### 3.925
Baba Make Parabox v3.925 是 2024.12.23 更新的一个版本，基本移除了在游戏过程中创建新的空间或关卡的能力，并使`GAME`支持了更多的属性。
...
#### 3.926
Baba Make Parabox v3.926 是 2025.01.05 更新的一个版本，修复了空间和关卡被转换后原物体不消失的漏洞，部分有关移动的代码逻辑，以及部分渲染平滑移动时出现的漏洞。
+ **技术性**
    + **`levels.MoveInfo`**
